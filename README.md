...
- [mlhher/late-cli](https://github.com/mlhher/late-cli) - Fully autonomous AI dev agent in pure Go built on empirical research. Get real work done on consumer hardware, even with tiny context windows.
