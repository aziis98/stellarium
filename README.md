...
- [sueszli/autograd.c](https://github.com/sueszli/autograd.c) - tiny torch, but close to metal
...
- [mlhher/late-cli](https://github.com/mlhher/late-cli) - AI agent for long-horizon tasks using local LLMs, cloud models, or both. Built on empirical research. Maintains coherence across 200k+ tokens of work with a 64k context window.
...
- [zamdzhiev/Qimaera](https://github.com/zamdzhiev/Qimaera) - Idris libraries for hybrid classical-quantum programming
...
- [deluf/unipi-plus-plus](https://github.com/deluf/unipi-plus-plus) - Estende il portale studenti dell'università di Pisa aggiungendo numerose statistiche sugli esami verbalizzati
...
- [holepunchto/pear](https://github.com/holepunchto/pear) - Peer-to-Peer (P2P) Install & Deploy CLI
...
- [k0a1a/hotglue2](https://github.com/k0a1a/hotglue2) - [ONGOING MAJOR UPDATE - WIP]  HOTGLUE is a Content Manipulation System which allows to construct websites directly in a web-browser.
...
- [lanaperisa/TensorToolbox.jl](https://github.com/lanaperisa/TensorToolbox.jl) - Julia package for tensors as multidimensional arrays, with functionalty within Tucker format, Kruskal (CP) format, Hierarchical Tucker format and Tensor Train format.
...
- [EPFL-LGG/ElasticRods_fork_tencers](https://github.com/EPFL-LGG/ElasticRods_fork_tencers) - Elastic Rod and X-Shell Simulation
...
- [cognitive-engineering-lab/document-calculus](https://github.com/cognitive-engineering-lab/document-calculus) - Accompanying materials for "A Core Calculus for Documents"
...
- [heavyrain266/colourspace](https://github.com/heavyrain266/colourspace) - A pragmatic set of modern colour space transforms
...
- [mbeher2200/DarkHours](https://github.com/mbeher2200/DarkHours) - Landscape Astrophotography and dark-sky planner — predicts weather, lunar cycles, Milky Way visibility, light pollution,  meteor showrs, and Auroras. It finds nearby dark-sky sites, and best nights.
- [Sentdex/minion](https://github.com/Sentdex/minion) - A tiny single-file coding agent for self-hosted models (llama.cpp / vLLM / SGLang).
...
- [distractedlambda/pille](https://github.com/distractedlambda/pille) - Extensible low-level programming
...
- [nopwashere/Rust-for-Arduboy](https://github.com/nopwashere/Rust-for-Arduboy) - 
...
- [nicksenger/glowstick](https://github.com/nicksenger/glowstick) - Type-level tensor shapes in Rust
...
- [LPTK/simpler-sub](https://github.com/LPTK/simpler-sub) - Oversimplified version of Simple-sub: without recursive types, without nested let polymorphism, and with approximated type-variable-to-type-variable constraints. Nevertheless, it's probably enough for
...
- [fiji/fiji](https://github.com/fiji/fiji) - A "batteries-included" distribution of ImageJ :battery:
...
- [BhorisDhanjal/MathCheatSheets](https://github.com/BhorisDhanjal/MathCheatSheets) - A few Mathematics Cheat Sheets I've made on LaTeX.
...
- [slkiser/opencode-quota](https://github.com/slkiser/opencode-quota) - OpenCode quota & tokens usage with zero context window pollution. Supports OpenCode Go, Cursor, GitHub Copilot, OpenAl, Kimi Code, Alibaba Coding Plan, Chutes Al, Google Antigravity, Z.ai Coding Plan 
...
- [mui/pigment-css](https://github.com/mui/pigment-css) - ⚠️ 𝐀𝐥𝐩𝐡𝐚 𝐩𝐡𝐚𝐬𝐞, currently, on hold. Pigment CSS is a zero-runtime CSS-in-JS library that extracts the colocated styles to their own CSS files at build time.
...
- [justplainstuff/plainstack](https://github.com/justplainstuff/plainstack) - A single-file web framework
